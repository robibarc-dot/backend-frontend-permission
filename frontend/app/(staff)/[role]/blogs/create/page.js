...
import { ChevronLeft, FilePlus2, Image as ImageIcon, Loader2, Plus, Save, Trash2, Upload } from "lucide-react";
import { useCreateBlogMutation } from "@/redux/features/blog/backend/blogApi";
...
export default function CreateBlogPage() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            setError(getRequestMessage(requestError, "Unable to create blog."));
        }
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <section className="rounded-[26px] bg-[linear-gradient(150deg,_#111827,_#1f2937)] p-8 text-white shadow-xl">
                    <div className="flex items-center gap-3 opacity-80">
                        ...
                        <p className="text-xs uppercase tracking-[0.28em]">Blog Management</p>
                    </div>
                    <h2 className="mt-4 text-3xl font-bold">Create Blog</h2>
                    <p className="mt-3 text-slate-400 max-w-2xl leading-relaxed">
                        Create a new blog post with title, module, short description, and content sections.
                    </p>
                </section>

...
export default function BlogsListPage() {
    ...
    const blogList = (blogs?.data || []).map((blog) => ({
        ...blog,
        name: blog.title,
    }));
    ...
    const filterConfigs = [
        { key: "title", label: "Title", type: "text", placeholder: "Search blogs..." },
        {
            key: "module_id",
            label: "Module",
            type: "select",
        ...
        },
        {
            ...
            render: (item) => (
                <>
                    ...
                    <Link
                        href={`/${resolvedRole}/blogs/edit/${item.id}`}
        ...
        <div className="p-6 max-w-[1600px] mx-auto space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 font-medium">Manage blog posts, modules, and content sections.</p>
                </div>
                <Link
                    href={`/${resolvedRole}/blogs/create`}

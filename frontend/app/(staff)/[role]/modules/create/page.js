...
import { useCreateModuleMutation } from "@/redux/features/common/backend/moduleApi";
...
export default function CreateModulePage() {
    ...
    const [createModule, { isLoading: saving }] = useCreateModuleMutation();
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            setError(requestError?.data?.message || "Unable to create module.");
        }
    }
        ...
        <div className="mx-auto space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <section className="rounded-[26px] bg-[linear-gradient(150deg,_#111827,_#1f2937)] p-8 text-white shadow-xl">
                    ...
                    <h2 className="mt-4 text-3xl font-bold">Create Module</h2>
                    <p className="mt-3 text-slate-400 max-w-2xl leading-relaxed">
                        Define a new course module like Reading, Listening, etc.
                    </p>
                </section>

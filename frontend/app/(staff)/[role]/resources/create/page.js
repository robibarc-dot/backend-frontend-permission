...
import { ChevronLeft, FilePlus2, Loader2, Plus, Save, Trash2 } from "lucide-react";
import { useCreateResourceMutation } from "@/redux/features/resource/backend/resourceApi";
...
export default function CreateResourcePage() {
    ...
    const [createResource, { isLoading: saving }] = useCreateResourceMutation();
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            setError(getRequestMessage(requestError, "Unable to create resource."));
        }
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <section className="rounded-[26px] bg-[linear-gradient(150deg,_#111827,_#1f2937)] p-8 text-white shadow-xl">
                    <div className="flex items-center gap-3 opacity-80">
                        ...
                        <p className="text-xs uppercase tracking-[0.28em]">Resource Management</p>
                    </div>
                    <h2 className="mt-4 text-3xl font-bold">Create Resource</h2>
                    <p className="mt-3 text-slate-400 max-w-2xl leading-relaxed">
                        Create a new learning resource with topic, module, and content sections.
                    </p>
                </section>

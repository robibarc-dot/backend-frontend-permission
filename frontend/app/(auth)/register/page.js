...
export default function RegisterPage() {
    ...
    return (
        /* Changed to h-screen and items-stretch to pin the viewport boundaries */
        <main className="bg-gray-50 h-screen w-screen flex items-stretch overflow-hidden font-sans">
            
            {/* Left Sidebar (Marketing Panel) */}
            {/* Added h-full and shrink-0 so it occupies exact layout space cleanly and won't compress */}
            ...
            {/* Added h-full and overflow-y-auto so ONLY this side scrolls when content spills over */}
            <section className="w-full lg:w-1/2 h-full bg-white flex flex-col items-center px-6 py-24 sm:px-16 relative overflow-y-auto">
                ...
                <div className="w-full max-w-md space-y-6 my-auto">
                    ...
                    <div className="bg-gray-100/80 p-1 rounded-xl flex items-center text-xs font-semibold text-gray-500">
                        <Link href="/login" className="w-1/2 py-2.5 rounded-lg text-center transition hover:text-gray-800">
                            Log In
                        </Link>
                    ...
                    <div className="space-y-1">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight flex items-center gap-2">
                            Create your account <span className="text-2xl">👋</span>
                        </h2>
                        <p className="text-xs sm:text-sm text-gray-400">Fill in your details to get started with your student workspace.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="name" className="text-[11px] font-bold text-gray-700 uppercase tracking-wide">
                                Full name
                            </label>
                        ...
                        {/* Email Input Group */}
                        <div className="space-y-1.5">
                            <label htmlFor="email" className="text-[11px] font-bold text-gray-700 uppercase tracking-wide">
                                Email address
                            </label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-gray-400">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="password" className="text-[11px] font-bold text-gray-700 uppercase tracking-wide">
                                Password
                            </label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-gray-400">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="password_confirmation" className="text-[11px] font-bold text-gray-700 uppercase tracking-wide">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-gray-400">
                    ...
                    <div className="text-center pt-2">
                        <p className="text-xs text-gray-400 font-medium">
                            Already a student?{" "}
                            <Link href="/login" className="text-[#ec1c76] font-bold hover:underline ml-1">
                                Sign in here
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-8 rounded-[20px] border border-amber-100 bg-amber-50/80 p-4 text-sm leading-6 text-slate-700">
                        Registration automatically sets your account as a{" "}
